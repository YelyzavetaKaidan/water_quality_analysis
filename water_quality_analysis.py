...
print("\nЗагальна мода (солоність) відносно водойми Bay: ", Mode(Bay_salinity_n))
print("Загальна мода (розчинений кисень) відносно водойми Bay: ", Mode(Bay_dis_oxy_n))
print("Загальна мода (водневий показник pH) відносно водойми Bay: ", Mode(Bay_ph_n))
print("Загальна мода (глибина Секкі) відносно водойми Bay: ", Mode(Bay_secchi_d_n))
print("Загальна мода (глибина води) відносно водойми Bay: ", Mode(Bay_water_d_n))
print("Загальна мода (температура води °C) відносно водойми Bay: ", Mode(Bay_w_temp_C_n))
print("Загальна мода (температура води °F) відносно водойми Bay: ", Mode(Bay_air_t_F_n))
print("Загальна мода (температура повітря °C) відносно водойми Bay: ", Mode(Bay_air_t_C_n))

#виведення значень (сер. арифм.) Bay
print("\nЗагальне середнє арифметичне (солоність) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_salinity_n), Bay_salinity_n))
print("Загальне середнє арифметичне (розчинений кисень) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_dis_oxy_n), Bay_dis_oxy_n))
print("Загальне середнє арифметичне (водневий показник pH) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_ph_n), Bay_ph_n))
print("Загальне середнє арифметичне (глибина Секкі) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_secchi_d_n), Bay_secchi_d_n))
print("Загальне середнє арифметичне (глибина води) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_water_d_n), Bay_water_d_n))
print("Загальне середнє арифметичне (температура води °C) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_w_temp_C_n), Bay_w_temp_C_n))
print("Загальне середнє арифметичне (температура води °F) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_air_t_F_n), Bay_air_t_F_n))
print("Загальне середнє арифметичне (температура повітря °C) відносно водойми Bay: ", Arithmetic_Mean(len(Bay_air_t_C_n), Bay_air_t_C_n))

#виведення значень (медіана) Bay
print("\nЗагальна медіана (солоність) відносно водойми Bay: ", Median(len(Bay_salinity_n), Bay_salinity_n))
print("Загальна медіана (розчинений кисень) відносно водойми Bay: ", Median(len(Bay_dis_oxy_n), Bay_dis_oxy_n))
print("Загальна медіана (водневий показник pH) відносно водойми Bay: ", Median(len(Bay_ph_n), Bay_ph_n))
print("Загальна медіана (глибина Секкі) відносно водойми Bay: ", Median(len(Bay_secchi_d_n), Bay_secchi_d_n))
print("Загальна медіана (глибина води) відносно водойми Bay: ", Median(len(Bay_water_d_n), Bay_water_d_n))
print("Загальна медіана (температура води °C) відносно водойми Bay: ", Median(len(Bay_w_temp_C_n), Bay_w_temp_C_n))
print("Загальна медіана (температура води °F) відносно водойми Bay: ", Median(len(Bay_air_t_F_n), Bay_air_t_F_n))
print("Загальна медіана (температура повітря °C) відносно водойми Bay: ", Median(len(Bay_air_t_C_n), Bay_air_t_C_n))
...
print("\nЗагальна мода (солоність) відносно водойми A: ", Mode(A_salinity_n))
print("Загальна мода (розчинений кисень) відносно водойми A: ", Mode(A_dis_oxy_n))
print("Загальна мода (водневий показник pH) відносно водойми A: ", Mode(A_ph_n))
print("Загальна мода (глибина Секкі) відносно водойми A: ", Mode(A_secchi_d_n))
print("Загальна мода (глибина води) відносно водойми A: ", Mode(A_water_d_n))
print("Загальна мода (температура води °C) відносно водойми A: ", Mode(A_w_temp_C_n))
print("Загальна мода (температура води °F) відносно водойми A: ", Mode(A_air_t_F_n))
print("Загальна мода (температура повітря °C) відносно водойми A: ", Mode(A_air_t_C_n))

#виведення значень (сер. арифм.) A
print("\nЗагальне середнє арифметичне (солоність) відносно водойми A: ", Arithmetic_Mean(len(A_salinity_n), A_salinity_n))
print("Загальне середнє арифметичне (розчинений кисень) відносно водойми A: ", Arithmetic_Mean(len(A_dis_oxy_n), A_dis_oxy_n))
print("Загальне середнє арифметичне (водневий показник pH) відносно водойми A: ", Arithmetic_Mean(len(A_ph_n), A_ph_n))
print("Загальне середнє арифметичне (глибина Секкі) відносно водойми A: ", Arithmetic_Mean(len(A_secchi_d_n), A_secchi_d_n))
print("Загальне середнє арифметичне (глибина води) відносно водойми A: ", Arithmetic_Mean(len(A_water_d_n), A_water_d_n))
print("Загальне середнє арифметичне (температура води °C) відносно водойми A: ", Arithmetic_Mean(len(A_w_temp_C_n), A_w_temp_C_n))
print("Загальне середнє арифметичне (температура води °F) відносно водойми A: ", Arithmetic_Mean(len(A_air_t_F_n), A_air_t_F_n))
print("Загальне середнє арифметичне (температура повітря °C) відносно водойми A: ", Arithmetic_Mean(len(A_air_t_C_n), A_air_t_C_n))

#виведення значень (медіана) A
print("\nЗагальна медіана (солоність) відносно водойми A: ", Median(len(A_salinity_n), A_salinity_n))
print("Загальна медіана (розчинений кисень) відносно водойми A: ", Median(len(A_dis_oxy_n), A_dis_oxy_n))
print("Загальна медіана (водневий показник pH) відносно водойми A: ", Median(len(A_ph_n), A_ph_n))
print("Загальна медіана (глибина Секкі) відносно водойми A: ", Median(len(A_secchi_d_n), A_secchi_d_n))
print("Загальна медіана (глибина води) відносно водойми A: ", Median(len(A_water_d_n), A_water_d_n))
print("Загальна медіана (температура води °C) відносно водойми A: ", Median(len(A_w_temp_C_n), A_w_temp_C_n))
print("Загальна медіана (температура води °F) відносно водойми A: ", Median(len(A_air_t_F_n), A_air_t_F_n))
print("Загальна медіана (температура повітря °C) відносно водойми A: ", Median(len(A_air_t_C_n), A_air_t_C_n))
...
print("\nЗагальна мода (солоність) відносно водойми B: ", Mode(B_salinity_n))
print("Загальна мода (розчинений кисень) відносно водойми B: ", Mode(B_dis_oxy_n))
print("Загальна мода (водневий показник pH) відносно водойми B: ", Mode(B_ph_n))
print("Загальна мода (глибина Секкі) відносно водойми B: ", Mode(B_secchi_d_n))
print("Загальна мода (глибина води) відносно водойми B: ", Mode(B_water_d_n))
print("Загальна мода (температура води °C) відносно водойми B: ", Mode(B_w_temp_C_n))
print("Загальна мода (температура води °F) відносно водойми B: ", Mode(B_air_t_F_n))
print("Загальна мода (температура повітря °C) відносно водойми B: ", Mode(B_air_t_C_n))

#виведення значень (сер. арифм.) B
print("\nЗагальне середнє арифметичне (солоність) відносно водойми B: ", Arithmetic_Mean(len(B_salinity_n), B_salinity_n))
print("Загальне середнє арифметичне (розчинений кисень) відносно водойми B: ", Arithmetic_Mean(len(B_dis_oxy_n), B_dis_oxy_n))
print("Загальне середнє арифметичне (водневий показник pH) відносно водойми B: ", Arithmetic_Mean(len(B_ph_n), B_ph_n))
print("Загальне середнє арифметичне (глибина Секкі) відносно водойми B: ", Arithmetic_Mean(len(B_secchi_d_n), B_secchi_d_n))
print("Загальне середнє арифметичне (глибина води) відносно водойми B: ", Arithmetic_Mean(len(B_water_d_n), B_water_d_n))
print("Загальне середнє арифметичне (температура води °C) відносно водойми B: ", Arithmetic_Mean(len(B_w_temp_C_n), B_w_temp_C_n))
print("Загальне середнє арифметичне (температура води °F) відносно водойми B: ", Arithmetic_Mean(len(B_air_t_F_n), B_air_t_F_n))
print("Загальне середнє арифметичне (температура повітря °C) відносно водойми B: ", Arithmetic_Mean(len(B_air_t_C_n), B_air_t_C_n))

#виведення значень (медіана) B
print("\nЗагальна медіана (солоність) відносно водойми B: ", Median(len(B_salinity_n), B_salinity_n))
print("Загальна медіана (розчинений кисень) відносно водойми B: ", Median(len(B_dis_oxy_n), B_dis_oxy_n))
print("Загальна медіана (водневий показник pH) відносно водойми B: ", Median(len(B_ph_n), B_ph_n))
print("Загальна медіана (глибина Секкі) відносно водойми B: ", Median(len(B_secchi_d_n), B_secchi_d_n))
print("Загальна медіана (глибина води) відносно водойми B: ", Median(len(B_water_d_n), B_water_d_n))
print("Загальна медіана (температура води °C) відносно водойми B: ", Median(len(B_w_temp_C_n), B_w_temp_C_n))
print("Загальна медіана (температура води °F) відносно водойми B: ", Median(len(B_air_t_F_n), B_air_t_F_n))
print("Загальна медіана (температура повітря °C) відносно водойми B: ", Median(len(B_air_t_C_n), B_air_t_C_n))
...
print("\nЗагальна мода (солоність) відносно водойми C: ", Mode(C_salinity_n))
print("Загальна мода (розчинений кисень) відносно водойми C: ", Mode(C_dis_oxy_n))
print("Загальна мода (водневий показник pH) відносно водойми C: ", Mode(C_ph_n))
print("Загальна мода (глибина Секкі) відносно водойми C: ", Mode(C_secchi_d_n))
print("Загальна мода (глибина води) відносно водойми C: ", Mode(C_water_d_n))
print("Загальна мода (температура води °C) відносно водойми C: ", Mode(C_w_temp_C_n))
print("Загальна мода (температура води °F) відносно водойми C: ", Mode(C_air_t_F_n))
print("Загальна мода (температура повітря °C) відносно водойми C: ", Mode(C_air_t_C_n))

#виведення значень (сер. арифм.) C
print("\nЗагальне середнє арифметичне (солоність) відносно водойми C: ", Arithmetic_Mean(len(C_salinity_n), C_salinity_n))
print("Загальне середнє арифметичне (розчинений кисень) відносно водойми C: ", Arithmetic_Mean(len(C_dis_oxy_n), C_dis_oxy_n))
print("Загальне середнє арифметичне (водневий показник pH) відносно водойми C: ", Arithmetic_Mean(len(C_ph_n), C_ph_n))
print("Загальне середнє арифметичне (глибина Секкі) відносно водойми C: ", Arithmetic_Mean(len(C_secchi_d_n), C_secchi_d_n))
print("Загальне середнє арифметичне (глибина води) відносно водойми C: ", Arithmetic_Mean(len(C_water_d_n), C_water_d_n))
print("Загальне середнє арифметичне (температура води °C) відносно водойми C: ", Arithmetic_Mean(len(C_w_temp_C_n), C_w_temp_C_n))
print("Загальне середнє арифметичне (температура води °F) відносно водойми C: ", Arithmetic_Mean(len(C_air_t_F_n), C_air_t_F_n))
print("Загальне середнє арифметичне (температура повітря °C) відносно водойми C: ", Arithmetic_Mean(len(C_air_t_C_n), C_air_t_C_n))

#виведення значень (медіана) C
print("\nЗагальна медіана (солоність) відносно водойми C: ", Median(len(C_salinity_n), C_salinity_n))
print("Загальна медіана (розчинений кисень) відносно водойми C: ", Median(len(C_dis_oxy_n), C_dis_oxy_n))
print("Загальна медіана (водневий показник pH) відносно водойми C: ", Median(len(C_ph_n), C_ph_n))
print("Загальна медіана (глибина Секкі) відносно водойми C: ", Median(len(C_secchi_d_n), C_secchi_d_n))
print("Загальна медіана (глибина води) відносно водойми C: ", Median(len(C_water_d_n), C_water_d_n))
print("Загальна медіана (температура води °C) відносно водойми C: ", Median(len(C_w_temp_C_n), C_w_temp_C_n))
print("Загальна медіана (температура води °F) відносно водойми C: ", Median(len(C_air_t_F_n), C_air_t_F_n))
print("Загальна медіана (температура повітря °C) відносно водойми C: ", Median(len(C_air_t_C_n), C_air_t_C_n))
...
print("\nЗагальна мода (солоність) відносно водойми D: ", Mode(D_salinity_n))
print("Загальна мода (розчинений кисень) відносно водойми D: ", Mode(D_dis_oxy_n))
print("Загальна мода (водневий показник pH) відносно водойми D: ", Mode(D_ph_n))
print("Загальна мода (глибина Секкі) відносно водойми D: ", Mode(D_secchi_d_n))
print("Загальна мода (глибина води) відносно водойми D: ", Mode(D_water_d_n))
print("Загальна мода (температура води °C) відносно водойми D: ", Mode(D_w_temp_C_n))
print("Загальна мода (температура води °F) відносно водойми D: ", Mode(D_air_t_F_n))
print("Загальна мода (температура повітря °C) відносно водойми D: ", Mode(D_air_t_C_n))

#виведення значень (сер. арифм.) D
print("\nЗагальне середнє арифметичне (солоність) відносно водойми D: ", Arithmetic_Mean(len(D_salinity_n), D_salinity_n))
print("Загальне середнє арифметичне (розчинений кисень) відносно водойми D: ", Arithmetic_Mean(len(D_dis_oxy_n), D_dis_oxy_n))
print("Загальне середнє арифметичне (водневий показник pH) відносно водойми D: ", Arithmetic_Mean(len(D_ph_n), D_ph_n))
print("Загальне середнє арифметичне (глибина Секкі) відносно водойми D: ", Arithmetic_Mean(len(D_secchi_d_n), D_secchi_d_n))
print("Загальне середнє арифметичне (глибина води) відносно водойми D: ", Arithmetic_Mean(len(D_water_d_n), D_water_d_n))
print("Загальне середнє арифметичне (температура води °C) відносно водойми D: ", Arithmetic_Mean(len(D_w_temp_C_n), D_w_temp_C_n))
print("Загальне середнє арифметичне (температура води °F) відносно водойми D: ", Arithmetic_Mean(len(D_air_t_F_n), D_air_t_F_n))
print("Загальне середнє арифметичне (температура повітря °C) відносно водойми D: ", Arithmetic_Mean(len(D_air_t_C_n), D_air_t_C_n))

#виведення значень (медіана) D
print("\nЗагальна медіана (солоність) відносно водойми D: ", Median(len(D_salinity_n), D_salinity_n))
print("Загальна медіана (розчинений кисень) відносно водойми D: ", Median(len(D_dis_oxy_n), D_dis_oxy_n))
print("Загальна медіана (водневий показник pH) відносно водойми D: ", Median(len(D_ph_n), D_ph_n))
print("Загальна медіана (глибина Секкі) відносно водойми D: ", Median(len(D_secchi_d_n), D_secchi_d_n))
print("Загальна медіана (глибина води) відносно водойми D: ", Median(len(D_water_d_n), D_water_d_n))
print("Загальна медіана (температура води °C) відносно водойми D: ", Median(len(D_w_temp_C_n), D_w_temp_C_n))
print("Загальна медіана (температура води °F) відносно водойми D: ", Median(len(D_air_t_F_n), D_air_t_F_n))
print("Загальна медіана (температура повітря °C) відносно водойми D: ", Median(len(D_air_t_C_n), D_air_t_C_n))
